...
parser.add_argument('--model-dir', type=str, default="exps/speed/model",
...
parser.add_argument('--save-frequency', type=float, default=100,
                    help="save once after N epochs")
parser.add_argument('--end-epoch', type=int, default=500,
...
if __name__ == "__main__":
    ...
    """
        ...
        epsilon = 1e-8
    """
    optimizer = torch.optim.Adagrad(net.net.parameters(),
                                     lr=args.lr_base,weight_decay=args.weight_decay)
